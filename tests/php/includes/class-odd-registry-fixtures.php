		...
		add_filter(
			...
			static function ( $sets ) use ( $slug ) {
				$sets[ $slug ] = array(
					...
					'icons'       => array(
						'odd'           => 'https://example.test/icons/' . rawurlencode( $slug ) . '/odd.webp',
						'my-wordpress'  => 'https://example.test/icons/' . rawurlencode( $slug ) . '/my-wordpress.webp',
						'content-graph' => 'https://example.test/icons/' . rawurlencode( $slug ) . '/content-graph.webp',
