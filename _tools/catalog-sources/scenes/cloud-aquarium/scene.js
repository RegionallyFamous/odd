/**
 * ODD scene: Cloud Aquarium - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient bubble motes, floating cloud tokens, and a
...
( function () {
	...
	var SLUG = 'cloud-aquarium';
	var TOKEN_KIND = 'cloud';
	var AMBIENT_KIND = 'bubble';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xffffff, 0xaeeaff, 0xffd6a5, 0x8fd7ff ];
	var ACCENT = 0xaeeaff;
