/**
 * ODD scene: Coral Arcade - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient bubble motes, floating shell tokens, and a
...
( function () {
	...
	var SLUG = 'coral-arcade';
	var TOKEN_KIND = 'shell';
	var AMBIENT_KIND = 'bubble';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xff6fae, 0x55e6ff, 0xffc85a, 0x91ffb8 ];
	var ACCENT = 0xff6fae;
