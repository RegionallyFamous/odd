/**
 * ODD scene: Crystal Subway - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient glint motes, floating crystal tokens, and a
...
( function () {
	...
	var SLUG = 'crystal-subway';
	var TOKEN_KIND = 'crystal';
	var AMBIENT_KIND = 'glint';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xb783ff, 0x78f0ff, 0xffd98a, 0xffffff ];
	var ACCENT = 0xb783ff;
