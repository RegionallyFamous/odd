/**
 * ODD scene: Neon Laundromat - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient steam motes, floating bubble tokens, and a
...
( function () {
	...
	var SLUG = 'neon-laundromat';
	var TOKEN_KIND = 'bubble';
	var AMBIENT_KIND = 'steam';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0x45e8ff, 0xff5da8, 0xffd271, 0xb57bff ];
	var ACCENT = 0x45e8ff;
