/**
 * ODD scene: Sticker Bomb Alley - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient spark motes, floating peel tokens, and a
...
( function () {
	...
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xff5fa8, 0x38e8ff, 0xffd84a, 0xb8ff5a ];
	var ACCENT = 0xff5fa8;
