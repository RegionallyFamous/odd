/**
 * ODD scene: Mushroom Radio - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient spore motes, floating ring tokens, and a
...
( function () {
	...
	var SLUG = 'mushroom-radio';
	var TOKEN_KIND = 'ring';
	var AMBIENT_KIND = 'spore';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xf2b45e, 0xa6ff73, 0xff74bb, 0x7bd1ff ];
	var ACCENT = 0xa6ff73;
