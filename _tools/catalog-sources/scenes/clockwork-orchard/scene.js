/**
 * ODD scene: Clockwork Orchard - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient firefly motes, floating leaf tokens, and a
...
( function () {
	...
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xd9aa4a, 0xff5e4d, 0x8bd96b, 0xf6e3a1 ];
	var ACCENT = 0xd9aa4a;
