/**
 * ODD scene: Desert Drive-In - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient dust motes, floating comet tokens, and a
...
( function () {
	...
	var SLUG = 'desert-drive-in';
	var TOKEN_KIND = 'comet';
	var AMBIENT_KIND = 'dust';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xffc16b, 0xff7a66, 0x9ec7ff, 0xf8f0c8 ];
	var ACCENT = 0xffc16b;
