/**
 * ODD scene: Rainbow Repair Shop - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient spark motes, floating prism tokens, and a
...
( function () {
	...
	var SLUG = 'rainbow-repair-shop';
	var TOKEN_KIND = 'prism';
	var AMBIENT_KIND = 'spark';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xff4f8b, 0x38e8ff, 0xffe35a, 0x8bff7a, 0xb266ff ];
	var ACCENT = 0x38e8ff;
