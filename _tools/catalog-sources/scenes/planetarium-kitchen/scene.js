/**
 * ODD scene: Planetarium Kitchen - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient steam motes, floating planet tokens, and a
...
( function () {
	...
	var SLUG = 'planetarium-kitchen';
	var TOKEN_KIND = 'planet';
	var AMBIENT_KIND = 'steam';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xffc86f, 0x9cc7ff, 0xe4b1ff, 0xffffff ];
	var ACCENT = 0x9cc7ff;
