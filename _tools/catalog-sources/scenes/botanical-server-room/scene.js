/**
 * ODD scene: Botanical Server Room - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient firefly motes, floating data tokens, and a
...
( function () {
	...
	var SLUG = 'botanical-server-room';
	var TOKEN_KIND = 'data';
	var AMBIENT_KIND = 'firefly';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0x56ff9a, 0x40e8ff, 0xb46dff, 0xf5d06f ];
	var ACCENT = 0x56ff9a;
