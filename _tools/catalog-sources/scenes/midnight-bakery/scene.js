/**
 * ODD scene: Midnight Bakery - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient flour motes, floating steam tokens, and a
...
( function () {
	...
	var SLUG = 'midnight-bakery';
	var TOKEN_KIND = 'steam';
	var AMBIENT_KIND = 'flour';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xffc16b, 0xfff1c2, 0x8fc4ff, 0xd89b65 ];
	var ACCENT = 0xffc16b;
