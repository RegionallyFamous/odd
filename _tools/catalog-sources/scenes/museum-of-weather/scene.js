/**
 * ODD scene: Museum of Weather - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient fog motes, floating storm tokens, and a
...
( function () {
	...
	var SLUG = 'museum-of-weather';
	var TOKEN_KIND = 'storm';
	var AMBIENT_KIND = 'fog';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0x9fd8ff, 0xffd06a, 0xffffff, 0xb5a0ff ];
	var ACCENT = 0x9fd8ff;
