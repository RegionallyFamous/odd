/**
 * ODD scene: Kelp Cathedral - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient bubble motes, floating bubble tokens, and a
...
( function () {
	...
	var SLUG = 'kelp-cathedral';
	var TOKEN_KIND = 'bubble';
	var AMBIENT_KIND = 'bubble';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0x62f2dc, 0x9ce36b, 0xe4c67a, 0x7bbdff ];
	var ACCENT = 0x62f2dc;
