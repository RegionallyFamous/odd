/**
 * ODD scene: Origami Harbor - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient spark motes, floating crane tokens, and a
...
( function () {
	...
	var SLUG = 'origami-harbor';
	var TOKEN_KIND = 'crane';
	var AMBIENT_KIND = 'spark';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xffd8a8, 0x9dd8ff, 0xff9ec8, 0xf7f1dc ];
	var ACCENT = 0x9dd8ff;
