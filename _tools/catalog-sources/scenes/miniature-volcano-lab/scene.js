/**
 * ODD scene: Miniature Volcano Lab - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient ash motes, floating ember tokens, and a
...
( function () {
	...
	var SLUG = 'miniature-volcano-lab';
	var TOKEN_KIND = 'ember';
	var AMBIENT_KIND = 'ash';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xff7a32, 0xffd65a, 0x8bd5ff, 0xffefe0 ];
	var ACCENT = 0xff7a32;
