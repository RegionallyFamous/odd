/**
 * ODD scene: Velvet Fossil Room - v1.0.0
 * ---------------------------------------------------------------
 * Painted backdrop (wallpaper.webp) with lightweight Pixi overlays:
 * ambient dust motes, floating fossil tokens, and a
...
( function () {
	...
	var SLUG = 'velvet-fossil-room';
	var TOKEN_KIND = 'fossil';
	var AMBIENT_KIND = 'dust';
	var TOKEN_COUNT = 8;
	var TOKEN_LOW = 4;
	var MOTE_COUNT = 72;
	var MOTE_LOW = 34;
	var PALETTE = [ 0xffbd62, 0xd68a4b, 0xffefd0, 0x9ed8ff ];
	var ACCENT = 0xffbd62;
